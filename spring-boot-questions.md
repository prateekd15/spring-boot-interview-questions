...
| [Explain the key features of Spring Boot.](#explain-the-key-features-of-spring-boot)|
| [What is the Spring Boot Starter?](#what-is-the-spring-boot-starter)|
| [What is Inversion of Control in Spring Boot?](#what-is-inversion-of-control-in-spring-boot)|
| [Explain Dependency Injection in Spring Boot.](#explain-dependency-injection-in-spring-boot)|
| [What are IOC containers in spring?](#what-are-ioc-containers-in-spring) |
| [What are the advantages of using Spring Boot for microservices development?](#what-are-the-advantages-of-using-spring-boot-for-microservices-development)|
| [What is the purpose of the Spring Boot Auto-Configuration feature?](#what-is-the-purpose-of-the-spring-boot-auto-configuration-feature)|
| [How can you customize the default behavior of Spring Boot?](#how-can-you-customize-the-default-behavior-of-spring-boot)|
| [What are Spring Boot Profiles, and why are they useful?](#what-are-spring-boot-profiles-and-why-are-they-useful)|
| [How can you use Spring Boot's support for conditional bean registration.](#how-can-you-use-spring-boots-support-for-conditional-bean-registration)|
| [List all the conditional annotations in Spring Boot.](#list-all-the-conditional-annotations-in-spring-boot)|
| [Explain the use of @ComponentScan annotation.](#explain-the-use-of-componentscan-annotation)|
| [What is the purpose of the @SpringBootApplication annotation?](#what-is-the-purpose-of-the-springbootapplication-annotation)|
| [Explain the use of @Component annotation.](#explain-the-use-of-component-annotation)|
| [Explain the use of @Service, @Repository, @RestController annotations](#explain-the-use-of-service-repository-restcontroller-annotations)|
| [Explain the difference between Spring Boot's @RestController and @Controller annotations.]()|
| [Explain exception handling in spring boot.](#explain-exception-handling-in-spring-boot)|
| [What is the purpose of ResponseEntityExceptionHandler in Spring Boot, and how does it relate to exception handling in a RESTful API?](#what-is-the-purpose-of-responseentityexceptionhandler-in-spring-boot-and-how-does-it-relate-to-exception-handling-in-a-restful-api)|
| [What is Spring Boot Actuator, and what kind of information can you gather from it?](#what-is-spring-boot-actuator-and-what-kind-of-information-can-you-gather-from-it)|
| [What is Spring Boot DevTools, and how can it aid in development?](#what-is-spring-boot-devtools-and-how-can-it-aid-in-development) | 
...
In Spring Framework, an IOC (Inversion of Control) container is a core component responsible for managing the lifecycle of Java objects (beans) and controlling the flow of their instantiation, configuration, and dependency injection. The primary purpose of an IOC container is to promote loose coupling, improve modularity, and make applications easier to maintain and test. Spring provides two main types of IOC containers:

1. **BeanFactory**: BeanFactory is the simplest IOC container provided by Spring. It is the foundation for the more advanced ApplicationContext. BeanFactory lazily initializes beans, meaning it only creates a bean when requested. This can be useful for conserving resources in applications where not all beans are needed immediately.

   Example of creating a BeanFactory:
...
2. **ApplicationContext**: ApplicationContext is a more feature-rich IOC container that builds on top of BeanFactory. It provides additional functionality, such as support for internationalization, event propagation, and integration with various Spring features like AOP (Aspect-Oriented Programming) and transaction management. ApplicationContext eagerly initializes beans by default, but you can still configure it for lazy initialization if needed.

   Example of creating an ApplicationContext in Spring Boot (a popular way to use Spring):
...
Both BeanFactory and ApplicationContext help manage beans and their dependencies through configuration metadata, which can be defined using XML files, Java annotations, or Java-based configuration classes. Spring resolves these dependencies and injects them into the beans, reducing the need for explicit object creation and manual wiring of components in your application. This inversion of control is what makes Spring a powerful framework for building modular, maintainable, and testable Java applications.
